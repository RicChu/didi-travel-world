...
全部來自 Wikimedia Commons，已裁切成 800×360（20:9）並壓縮，**每張都是該日行程的實際地點**。
原始檔名可直接在 `https://commons.wikimedia.org/wiki/File:<原始檔名>` 查到授權頁。
...
| `hagia-sophia.jpg` | 11/06 | 聖索菲亞 · Sultanahmet 廣場 | `Hagia Sophia and German Fountain in 2016 1504.jpg` | Dosseman | CC BY-SA 4.0 |
| `topkapi-palace.jpg` | 11/08 | Topkapı 皇宮 崇敬之門 | `Topkapı Gate of Salutation At front side in 2008 02 2.jpg` | Dosseman | CC BY-SA 4.0 |
...
| `balloon-ride.jpg` | 11/02 熱氣球說明卡 | 使用者於 2026-08-22 提供（取代原本 Wolfgang Moroder 的 CC BY-SA 3.0 照片） |
